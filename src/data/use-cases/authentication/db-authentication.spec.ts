...
import { UpdateAccessTokenRepository } from '../../protocols/db/mongo/update-access-token-repository'
...
const makeSut = (): SutTypes => {
  ...
  const updateAccessTokenRepositoryStub = makeUpdateAccessTokenRepositorySutb()
